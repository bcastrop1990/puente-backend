...
public class ListaGenerica implements ORAData, ORADataFactory,Serializable {

    private static final ListaGenerica arrayFactory =new ListaGenerica();
    ...
    public Datum toDatum(Connection conn) throws SQLException {
        ...
        try {
            arrayDesc =ArrayDescriptor.createDescriptor(this.getSqlName(), conn);
