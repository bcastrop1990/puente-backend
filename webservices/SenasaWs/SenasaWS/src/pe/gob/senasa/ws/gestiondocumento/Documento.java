...
public class Documento implements java.io.Serializable {
    ...
    private pe.gob.senasa.ws.gestiondocumento.Version[] versiones;

    public Documento() {
    }

    public Documento(java.lang.String id, java.lang.String nombre,
                     java.lang.String url,
                     pe.gob.senasa.ws.gestiondocumento.Version[] versiones) {
        this.id = id;
        this.nombre = nombre;
        this.url = url;
     ...
     * @return versiones
     */
    public pe.gob.senasa.ws.gestiondocumento.Version[] getVersiones() {
        return versiones;
    }
     ...
     * @param versiones
     */
    public void setVersiones(pe.gob.senasa.ws.gestiondocumento.Version[] versiones) {
        this.versiones = versiones;
    }

    public pe.gob.senasa.ws.gestiondocumento.Version getVersiones(int i) {
        return this.versiones[i];
    }

    public void setVersiones(int i,
                             pe.gob.senasa.ws.gestiondocumento.Version _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals =
                true && ((this.id == null && other.getId() == null) || (this.id !=
                                                                        null &&
                ...
                ((this.versiones == null && other.getVersiones() == null) ||
                 (this.versiones != null &&
                  java.util.Arrays.equals(this.versiones,
                                          other.getVersiones())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVersiones() != null) {
            for (int i = 0;
                 i < java.lang.reflect.Array.getLength(getVersiones()); i++) {
                java.lang.Object obj =
                    java.lang.reflect.Array.get(getVersiones(), i);
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://gestiondocumento.ws.senasa.gob.pe",
                                                           "version"));
        elemField.setMinOccurs(0);
