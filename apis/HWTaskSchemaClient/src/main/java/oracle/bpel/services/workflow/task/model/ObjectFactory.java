...
public class ObjectFactory {
    ...
    private final static QName _Comment_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/task", "comment");
    ...
    /**
     * Create an instance of {@link HTResgistrarSolicitudPayloadType }
     * 
     */
    public HTResgistrarSolicitudPayloadType createHTResgistrarSolicitudPayloadType() {
        return new HTResgistrarSolicitudPayloadType();
    }
    ...
    /**
     * Create an instance of {@link HiddenAttributesType }
     * 
     */
    public HiddenAttributesType createHiddenAttributesType() {
        return new HiddenAttributesType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/task", name = "comment")
