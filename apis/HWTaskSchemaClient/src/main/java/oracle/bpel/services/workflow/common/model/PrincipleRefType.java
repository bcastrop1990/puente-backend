...
/**
 * <p>Clase Java para principleRefType complex type.
 * 
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="type" use="required" type="{http://xmlns.oracle.com/bpel/workflow/common}participantTypeEnum" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "principleRefType", propOrder = {
    "realm",
    "name"
})
public class PrincipleRefType {
    ...
    /**
     * Obtiene el valor de la propiedad realm.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad realm.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
