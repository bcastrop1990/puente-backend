...
public class ParallelType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "taskSequence", namespace = "http://xmlns.oracle.com/bpel/workflow/taskQueryService", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "taskSequenceGroup", namespace = "http://xmlns.oracle.com/bpel/workflow/taskQueryService", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "parallel", namespace = "http://xmlns.oracle.com/bpel/workflow/taskQueryService", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "taskSequenceRecord", namespace = "http://xmlns.oracle.com/bpel/workflow/taskQueryService", type = JAXBElement.class, required = false)
    })
    ...
    @XmlAttribute(name = "stageDisplayName")
