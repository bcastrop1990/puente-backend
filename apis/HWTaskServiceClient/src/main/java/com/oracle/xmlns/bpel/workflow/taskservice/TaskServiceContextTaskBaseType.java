...
/**
 * <p>Java class for taskServiceContextTaskBaseType complex type.
 * 
...
@XmlType(name = "taskServiceContextTaskBaseType", propOrder = {
    "workflowContext",
    "task"
})
@XmlSeeAlso({
    CreateToDoTaskType.class,
    RestartRootTaskType.class
})
public class TaskServiceContextTaskBaseType {
