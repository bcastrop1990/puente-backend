 ...
 * generated in the com.oracle.xmlns.bpel.workflow.taskservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdateTasksByCommands_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/taskService", "updateTasksByCommands");
    private final static QName _UpdateTasksByCommandsOutput_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/taskService", "updateTasksByCommandsOutput");
    private final static QName _UpdateArchivedOnValueForTasks_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/taskService", "updateArchivedOnValueForTasks");
    private final static QName _AddCommentToTasksTaskId_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/taskService", "taskId");
    private final static QName _AddCommentToTasksComment_QNAME = new QName("http://xmlns.oracle.com/bpel/workflow/taskService", "comment");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.xmlns.bpel.workflow.taskservice
     * 
     */
    ...
    /**
     * Create an instance of {@link UpdateTasksByCommandsType }
     * 
     */
    public UpdateTasksByCommandsType createUpdateTasksByCommandsType() {
        return new UpdateTasksByCommandsType();
    }

    /**
     * Create an instance of {@link UpdateTasksByCommandsOutputType }
     * 
     */
    public UpdateTasksByCommandsOutputType createUpdateTasksByCommandsOutputType() {
        return new UpdateTasksByCommandsOutputType();
    }

    /**
     * Create an instance of {@link ArchivedOnIdsListType }
     * 
     */
    public ArchivedOnIdsListType createArchivedOnIdsListType() {
        return new ArchivedOnIdsListType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UpdateTasksByCommandsType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "updateTasksByCommands")
    public JAXBElement<UpdateTasksByCommandsType> createUpdateTasksByCommands(UpdateTasksByCommandsType value) {
        return new JAXBElement<UpdateTasksByCommandsType>(_UpdateTasksByCommands_QNAME, UpdateTasksByCommandsType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UpdateTasksByCommandsOutputType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "updateTasksByCommandsOutput")
    public JAXBElement<UpdateTasksByCommandsOutputType> createUpdateTasksByCommandsOutput(UpdateTasksByCommandsOutputType value) {
        return new JAXBElement<UpdateTasksByCommandsOutputType>(_UpdateTasksByCommandsOutput_QNAME, UpdateTasksByCommandsOutputType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArchivedOnIdsListType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "updateArchivedOnValueForTasks")
    public JAXBElement<ArchivedOnIdsListType> createUpdateArchivedOnValueForTasks(ArchivedOnIdsListType value) {
        return new JAXBElement<ArchivedOnIdsListType>(_UpdateArchivedOnValueForTasks_QNAME, ArchivedOnIdsListType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "taskId", scope = AddCommentToTasks.class)
    public JAXBElement<String> createAddCommentToTasksTaskId(String value) {
        return new JAXBElement<String>(_AddCommentToTasksTaskId_QNAME, String.class, AddCommentToTasks.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "comment", scope = AddCommentToTasks.class)
    public JAXBElement<String> createAddCommentToTasksComment(String value) {
        return new JAXBElement<String>(_AddCommentToTasksComment_QNAME, String.class, AddCommentToTasks.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/bpel/workflow/taskService", name = "comment", scope = AddCommentType.class)
    public JAXBElement<String> createAddCommentTypeComment(String value) {
        return new JAXBElement<String>(_AddCommentToTasksComment_QNAME, String.class, AddCommentType.class, value);
    }
